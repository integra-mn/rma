...
$routes = [
    'GET' => [
        ...
        '/rma/insurance-check'         => 'rma/insurance_status',
    ...
    'POST' => [
        ...
        '/admin/insurer/store'                 => 'admin/insurer_store',
        '/admin/insurer/update'                => 'admin/insurer_update',
        '/admin/product/store'                 => 'admin/product_store',
        '/admin/product/update'                => 'admin/product_update',
        '/admin/coverage/store'                => 'admin/coverage_store',
