...
<div style="padding:1.5rem;">
  ...
  <!-- Tabs -->
  <div class="tab-bar">
    <?php foreach (['users'=>__('admin.users'),'locations'=>__('admin.locations'),'devices'=>__('nav.devices'),'couriers'=>__('nav.shipments'),'statuses'=>__('admin.statuses')] as $t => $l): ?>
  ...
  <?php if ($tab === 'devices'): ?>
    <!-- Devices: full page width — tables with many action buttons need room. -->
    <?php include views_path('devices/index.php'); ?>

  <?php else: ?>
    <!-- All other tabs: capped at --w-content. -->
